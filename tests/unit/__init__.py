...
if TYPE_CHECKING:
    ...
    from .test_e2e import TestsFlextTargetOracleOicE2e
    from .test_e2e_sinks import DummySingerTargetE2E, TestsFlextTargetOracleOicE2eSinks
    ...
    from .test_target import (
        ...
        _TokenWithoutAccessTokenHandler,
    )
__all__: tuple[str, ...] = (
    "AuthTestSettings",
    "DummySingerTarget",
