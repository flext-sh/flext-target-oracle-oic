...
<!-- Source of truth: `<workspace-root>/docs/guides/getting-started.md`; adjust that workspace source, never this member projection. -->

# flext-target-oracle-oic - Getting Started
