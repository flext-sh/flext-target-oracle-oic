<!-- Generated from docs/guides/development.md for flext-target-oracle-oic. -->

<!-- Source of truth: workspace docs/guides/. -->

# flext-target-oracle-oic - FLEXT Development Guide
...
def process_data(data: Mapping[str, t.NormalizedValue]) -> r[ProcessedData]:
