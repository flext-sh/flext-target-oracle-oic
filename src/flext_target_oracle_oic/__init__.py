...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "OICConnectionSettings": ("flext_target_oracle_oic.connection", "OICConnectionSettings"),
    ...
    "OICTargetOrchestrator": ("flext_target_oracle_oic.application", "OICTargetOrchestrator"),
    ...
    "TargetOracleOicConfig": ("flext_target_oracle_oic.target_config", "TargetOracleOicConfig"),
